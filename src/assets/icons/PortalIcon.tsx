...
export function PortalIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.5 21.9805H7.5C3.5 21.9805 2.5 20.9805 2.5 16.9805V8.98047C2.5 4.98047 3.5 3.98047 7.5 3.98047H17.5C21.5 3.98047 22.5 4.98047 22.5 8.98047V16.9805C22.5 20.9805 21.5 21.9805 17.5 21.9805Z" stroke="#35663A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M14.5 8.98047H19.5" stroke="#35663A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M15.5 12.9805H19.5" stroke="#35663A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M17.5 16.9805H19.5" stroke="#35663A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
