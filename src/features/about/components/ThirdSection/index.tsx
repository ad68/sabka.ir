...
export default function Index () {
    return (
        ...
        >
            <section>
                <h3 className='max-w-x md:max-w-sm text-xl md:text-3xl font-bold text-[#fff] 2xl:max-w-xl 2xl:text-4xl'>وظايف و حدود عمليات صندوق بيمه كشاورزی</h3>
                <p className='max-w-lg text-[16px] text-[#fff] mt-4 text-justify pl-6 2xl:text-[20px] 2xl:mt-8 2xl:pl-6'>
