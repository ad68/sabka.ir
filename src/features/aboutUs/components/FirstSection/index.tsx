    ...
    return (
        <section className="flex flex-col justify-center items-center mb-[70px] 2xl:mb-[120px]">
            <section className="flex flex-col justify-center items-center my-[48px] 2xl:my-[100px] max-w-2xl 2xl:max-w-4xl gap-4">
                <p className="text-[#284D2C] md:text-4xl 2xl:text-4xl text-center xl:mb-3">
                    با هم، آینده‌ای <span className="text-[#558C5A]">ســرســـبز</span> می‌سازیم
                </p>
                <p className="text-[16px] text-[#A0A0A0] 2xl:text-2xl text-center">
