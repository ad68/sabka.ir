    ...
    return (
        <section className='w-full relative flex flex-col md:flex-row gap-2 justify-center items-center p-6 py-[60px]  '>
            ...
            <section className="order-1 xl:order-2">
                ...
                <p className='max-w-lg 2xl:max-w-xl text-[#A0A0A0] mt-[8px] text-justify 2xl:mt-[16px]'>به منظور حمایت از کشاورزان و دامدارانی که محصولاتشان بر اثر حوادث قهری و طبیعی دچار خسارت می شد و برای کمک به ادامه فعالیت تولیدی آنان، شورای انقلاب اسلامی در تاریخ هشتم بهمن ماه سال 1358، مصوب نمود صندوق ویژه ای به نام صندوق کمک به خسارت دیدگان محصولات کشاورزی و دامی در بانک کشاورزی تشکیل شود. بر اساس تبصره پنج مصوبه شورای انقلاب، وزارت کشاورزی مکلف شد ظرف مدت پنج سال از تصویب این قانون، مطالعات و اقدامات لازم را در مورد اجرای مقررات بیمه محصولات کشاورزی انجام داده و لایحه آن را تهیه نماید.
