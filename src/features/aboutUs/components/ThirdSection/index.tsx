...
export default function Index () {
    return (
        <section className='w-full relative flex flex-col md:flex-row  gap-2 justify-center items-center p-10 md:p-20 min-h-screen '
        style={{backgroundImage: `url(${ThirdSectionBg.src})`}}
        >
            <section>
                <h3 className='max-w-x md:max-w-sm text-[24px] md:text-3xl font-bold text-[#fff] 2xl:max-w-xl 2xl:text-4xl'>وظايف و حدود عمليات صندوق بيمه كشاورزی</h3>
                <p className='max-w-lg text-[16px] text-[#fff] mt-4 text-justify md:pl-6 2xl:text-[20px] 2xl:mt-8 2xl:pl-6'>
            ...
            <section className="relative w-[350px] h-[274px] md:w-[437px]  md:h-[356px] mt-[30px] mb-[50px]">
                <Image
                    src="/assets/img/about/ThirdSection.png"
                    alt=""
                    fill
