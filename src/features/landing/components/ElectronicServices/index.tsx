...
const items = [
    { title: 'درگاه ملی مجوزها', icon: <CertificateIcon />, link: '' },
    { title: 'فصل نامه بیمه کشاورزی', icon: <CalendarIcon />, link: '' },
    { title: 'صدور بیمه نامه', icon: <InsuranceLetterIcon />, link: '' },
    { title: 'آیین نامه ها و دستورالعمل ها', icon: <RulesIcon />, link: '' },
    { title: 'استعلام بیمه نامه', icon: <InquiryIcon />, link: '' },
    { title: 'میز ارتباط مردمی', icon: <ServiceDeskIcon />, link: '' },
    ...
    return (
        <section className="w-full relative mt-[50px] xl:mt-[150px]">
            ...
            >
                ...
                <div className='flex w-[707px] flex-col justify-start items-start xl:justify-center xl:items-center gap-6 min-h-[400px]' >
