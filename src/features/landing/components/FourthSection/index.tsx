...
export default function Index() {
    ...
    return (
        <section
            className="w-full mt-[150px] relative"
        >
            <Image alt="" width={700} height={900} className="w-[200px] xl:w-[400px] top-[-150px] absolute" src={LeafRightBg} />
            <div className="max-w-6xl m-auto justify-center">
                <div className="w-full mt-8 flex flex-col justify-center items-center md:justify-center md:items-center gap-3">
                    <span className="flex flex-row gap-2">
                        کشاورزی، ستون خودکفایی ملی
                        <LeafIcon />
                    </span>
                    <p className="text-center text-xl md:text-3xl font-bold">دسترسی سریع به خدمات و اطلاعات</p>
                    <div className="text-center max-w-2xl">با استفاده از تب‌های زیر، به آسانی به بخش‌های مختلف سامانه دسترسی پیدا کنید.</div>
                </div>
                <div className="w-full mx-auto p-6 flex flex-col justify-center items-center gap-6">
                    ...
                    <div className="w-full mx-auto grid grid-cols-2 xl:grid-cols-3  md:justify-center md:items-center md:flex-wrap gap-3 md:gap-4">
