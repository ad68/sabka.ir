        ...
        <section className="w-full mt-[96px] xl:mt-[150px]">
            ...
            >
                <div className='w-full mt-8 flex flex-col justify-start items-start md:justify-start md:items-start gap-3'>
                    <span className='flex flex-row gap-2 text-[18px] xl:text-[32px]'>
                ...
                <div className='flex flex-col xl:flex-row justify-center items-end gap-[22px] mt-[48px]'>
                    <div
                        ...
                        <div className="grid grid-cols-2 order-1 xl:order-2 md:grid-cols-3 gap-4 items-center w-full mt-[15px] bg-gradient-to-t from-[#f3fce8] to-[#edffff] p-3">
