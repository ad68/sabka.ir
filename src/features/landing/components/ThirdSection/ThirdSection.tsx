...
export default function Index() {
    return (
        <section
            className='w-full flex flex-col  gap-2 justify-center items-center mt-[158px] overflow-x-hidden'>
            ...
            <div className="flex items-center justify-start  ">
                <div className="flex flex-col md:flex-row max-w-full justify-start md:justify-center md:max-w-6xl items-start md:items-center w-full bg-white rounded-xl p-6">
                    ...
                    <div className="flex-1 p-6 relative max-w-md  bg-white  border-0 overflow-visible border-r-[#35663A] border-r-8 mt-[-80px] md:mt-0 mr-[70px] w-[400px] md:max-w-[450px] md:mr-[-60px] rounded-xl  max-h-[320px] shadow-2xl">
                        ...
                        <div className="text-md md:text-lg max-w-xs font-semibold text-gray-800 mb-2">
