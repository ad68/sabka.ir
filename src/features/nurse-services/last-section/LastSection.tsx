...
export default function NurseServiceLastSection(){
    return(
        <section className='w-full max-w-6xl m-auto flex items-center justify-center flex-col gap-4 mt-10  min-h-screen'>
            <section className="w-full md:w-1/2 xl:w-full flex justify-center mt-0 md:mt-[-80px] lg:mt-[-180px] xl:mt-[-80px]">
                <section className="w-full max-w-md">
                    <Image
                        src="/assets/img/nurse-services/last-section.png"
                        alt="zhavar"
                        width={800}
                        height={640}
            ...
            <p className='w-full max-w-2xl px-6 md:px-1 md:max-w-3xl text-center'>اگر پرستار حرفه‌ای یا مجموعه‌ای معتبر در حوزه مراقبت و پرستاری هستید، جای شما در کنار ما خالی‌ست.
                ما در تلاشیم تا با گردآوری نیروهای مجرب و دلسوز، خدمات مراقبتی با کیفیت و مطمئن به خانواده‌ها ارائه دهیم. اگر باور دارید که تخصص، تعهد و همراهی می‌تواند آرامش را به خانه‌های بیشتری بیاورد، از شما دعوت می‌کنیم تا به جمع ما بپیوندید.</p>
