...
export default function PetServiceFifthSection(){
        ...
        <section className='w-full rounded-2xl  overflow-hidden  border-r-[1px] p-2 md:p-0'>
            ...
            >
                ...
                <span className="flex flex-row gap-2 justify-center md:justify-start items-center ">
                          <span className="text-black ">همراهی همیشگی و عاشقانه</span>
                            <StarTwoIcon className='w-5 h-5' color={'#FF7700'}/>
                       </span>
                    <p className="text-lg md:text-xl tracking-wide mt-2">
                        <span className='font-bold'>فراتر از مراقبت،</span>تجربه‌ای زیبا برای شما و حیوان خانگی‌تان
                    </p>
                    <p className='font-normal text-sm mt-4 md:mt-2'>ما در ژوار می‌دانیم رابطه‌ شما با حیوان خانگی‌تان، فقط نگهداری نیست—خاطره، همراهی و عشق است. به همین دلیل، خدمات ما فقط محدود به مراقبت‌های روزمره نمی‌شود؛ از پیاده‌روی تا خدمات دامپزشکی در منزل، از آموزش تا نگهداری موقت، هرچیزی که نیاز داشته باشید با احترام و دقت ارائه می‌شود. اینجا، هر خدمت با دل انجام می‌شود، نه فقط با دست.</p>
                ...
                <section className="flex-shrink-0 flex-grow-0 basis-[350px]">
                    <Image
                        src="/assets/img/pet-services/fifth-section-f.png"
                        alt="zhavar"
                        priority
                        layout="responsive"
                        width={350}
